    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="汽车颜色" prop="qicheyanse">
          <el-select :disabled="ro.qicheyanse" v-model="ruleForm.qicheyanse" placeholder="请选择汽车颜色">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="天窗" prop="tianchuang">
          <el-select :disabled="ro.tianchuang" v-model="ruleForm.tianchuang" placeholder="请选择天窗">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="汽车状态" prop="qichezhuangtai">
        ...
        <div v-else>
          <el-form-item class="input" label="汽车状态" prop="qichezhuangtai">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="每日租金" prop="meirizujin">
          <el-input v-model="ruleForm.meirizujin" 
              placeholder="每日租金" clearable  :readonly="ro.meirizujin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="每日租金" prop="meirizujin">
              <el-input v-model="ruleForm.meirizujin" 
                placeholder="每日租金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.tianchuangOptions = "有天窗,无天窗".split(',')
	...
	this.ruleForm.qichexiangqing = this.ruleForm.qichexiangqing.replace(reg,'../../../nodejsi4y64/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

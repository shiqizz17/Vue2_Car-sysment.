<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="租赁日期" prop="zulinriqi">
          <el-input v-model="ruleForm.zulinriqi" 
              placeholder="租赁日期" clearable  :readonly="ro.zulinriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="租赁日期" prop="zulinriqi">
              <el-input v-model="ruleForm.zulinriqi" 

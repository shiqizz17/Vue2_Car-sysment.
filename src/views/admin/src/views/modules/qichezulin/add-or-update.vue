<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="汽车状态" prop="qichezhuangtai">
          <el-input v-model="ruleForm.qichezhuangtai" 
              placeholder="汽车状态" clearable  :readonly="ro.qichezhuangtai"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  computed: {
    ...
    zongjine:{
      get: function () {
        return 1*this.ruleForm.meirizujin*this.ruleForm.zulintianshu
      }
    },

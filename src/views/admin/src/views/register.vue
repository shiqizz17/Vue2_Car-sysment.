      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.xinyongfen" class="input" type="text" placeholder="信用分">
			   </div>
			 </div> -->
			<el-form-item label="信用分" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.xinyongfen" autocomplete="off" placeholder="信用分"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<el-form-item label="员工工号" class="input" v-if="tableName=='gongzuorenyuan'">
			...
			<el-form-item label="员工姓名" class="input" v-if="tableName=='gongzuorenyuan'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='gongzuorenyuan'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`yonghu` == this.tableName && this.ruleForm.xinyongfen&&(!this.$validate.isIntNumer(this.ruleForm.xinyongfen))){
        this.$message.error(`信用分应输入整数`);
        return
      }
      ...
      if(`gongzuorenyuan` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){

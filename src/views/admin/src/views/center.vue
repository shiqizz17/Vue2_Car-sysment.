     ...
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="信用分" prop="xinyongfen">
          <el-input v-model="ruleForm.xinyongfen"               placeholder="信用分" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='gongzuorenyuan'"  label="员工工号" prop="yuangonggonghao">
          <el-input v-model="ruleForm.yuangonggonghao" readonly              placeholder="员工工号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='gongzuorenyuan'"  label="员工姓名" prop="yuangongxingming">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='gongzuorenyuan'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='gongzuorenyuan'"  label="联系电话" prop="lianxidianhua">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'yonghu' ==this.flag && this.ruleForm.xinyongfen&&(!isIntNumer(this.ruleForm.xinyongfen))){
      ...
      if( 'gongzuorenyuan' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
